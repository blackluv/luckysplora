...
pub fn bitcoin_genesis_hash(network: BNetwork) -> bitcoin::BlockHash {
    ...
    match network {
        BNetwork::Bitcoin => BlockHash::from_raw_hash(bitcoin::hashes::sha256d::Hash::from_slice(&<[u8; 32] as FromHex>::from_hex("9b7bce58999062b63bfb18586813c42491fa32f4591d8d3043cb4fa9e551541b").unwrap()).unwrap()),
